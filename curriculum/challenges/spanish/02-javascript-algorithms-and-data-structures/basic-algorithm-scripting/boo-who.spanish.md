...
## Description
<section id="description"> Compruebe si un valor está clasificado como un booleano primitivo. Devuelve verdadero o falso. Los primitivos booleanos son verdaderos y falsos. Recuerda usar <a href="http://forum.freecodecamp.org/t/how-to-get-help-when-you-are-stuck/19514" target="_blank">Read-Search-Ask</a> si te atascas. Trate de hacer programación de pares. Escribe tu propio código. </section>
...
function booWho(bool) {
  // Cual es la nueva dieta de moda para los desarroladores fantasmas? La Boolean.
  return bool;
}
